...
to enhance its functionality via packages. `r Biocpkg("chevreulProcess")` is a `R` 
...
`r Biocpkg("chevreulProcess")` by using the following commands in your `R` session:
...
The `r Biocpkg("chevreulProcess")` package is designed for single-cell RNA sequencing
...
The `chevreulProcess` package contains functions to preprocess, cluster, visualize, and 
